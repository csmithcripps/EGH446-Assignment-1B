...
exovt42qxt ; real_T db1e0tgf4x ; real_T ofwbl3a4zg ; real_T lhggxwrwhf ;
real_T cviplrj0tr ; real_T bre5cnwes5 ; real_T ht4canyxjr ; real_T h5hetjludb
; real_T dlpo2pe5rr ; real_T mkahxkyn1x ; real_T hkkoxujb3d ; } nzedqmilb2 ;
...
struct kyvdc2iekoi_ { real_T P_1 ; real_T P_2 [ 2 ] ; real_T P_3 ; real_T P_4
; real_T P_5 ; real_T P_6 ; real_T P_7 ; real_T P_8 ; real_T P_9 ; real_T
P_10 ; real_T P_11 ; } ; struct fbsae5kyyl { struct SimStruct_tag *
...
] ; RTWLoggingFcnPtr loggingPtrs [ 4 ] ; sysRanDType * systemRan [ 4 ] ;
int_T systemTid [ 4 ] ; } DataMapInfo ; struct { int_T mdlref_GlobalTID [ 2 ]
; } Timing ; } ; typedef struct { nzedqmilb2 rtb ; jhzhbof20x rtdw ;
j2huxwjt4d rtm ; } ekeuq13di1j ; extern struct_KgyuWirBFPgZYO8JXc0O3B rtP_veh
; extern void erydabnrep ( SimStruct * _mdlRefSfcnS , int_T mdlref_TID0 ,
int_T mdlref_TID1 , j2huxwjt4d * const hobuwbvixl , nzedqmilb2 * localB ,
jhzhbof20x * localDW , gactmdiaa1 * localX , void * sysRanPtr , int
...
bh_DDR_component_model ( const real_T * i5ntoahcdk , const real_T *
nvje5zq2o1 , real_T * m1i4qmwhzl , real_T * fstmgkf35t , real_T * h3vjgejhf4
, real_T e4uvcdk54s [ 2 ] , real_T ccwhyw3z5n [ 2 ] , real_T j2wj3a1r4n [ 2 ]
, real_T bped04z5az [ 2 ] , real_T cggdc1bpaw [ 2 ] , real_T * gaqlt05bjk ,
real_T * mtwsk1yeax , real_T * gp4bu05qnz , real_T * bqonsvzrgk , real_T *
ghn2nxly15 , real_T * kesth4x2ap , real_T * czk4kp0oz4 , real_T * hhezpj2fwm
, real_T * klb3dtnhre , real_T * emokchsxwx , real_T * ob2lnwtug2 , real_T *
ovtdwwd1dn , real_T * c41ibpcltn , real_T * mxkxrtj1ce , real_T * hnc3jtlmqc
, real_T * cxub3fha1r , real_T b2bawpqkdg [ 3 ] , real_T l0oh1v00tg [ 2 ] ,
real_T fvrrayoptg [ 2 ] , real_T hnahwjzsa0 [ 3 ] , real_T * icnuizkgs5 ,
real_T * imfkrdxtrb , nzedqmilb2 * localB , jhzhbof20x * localDW , gactmdiaa1
* localX ) ; extern void bh_DDR_component_modelTID1 ( nzedqmilb2 * localB ) ;
extern void ojgv1fm03w ( j2huxwjt4d * const hobuwbvixl ) ;
#endif
