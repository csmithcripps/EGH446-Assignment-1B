...
PRODUCT                 = bh_DDR_component_modellib.lib
...
MASTER_ANCHOR_DIR       = 
START_DIR               = C:\Users\CodyS\OneDrive\DOCUME~1\Uni\2020_S~1\EGH446\ASSIGN~1\sim_env
S_FUNCTIONS_LIB         = 
NUMST                   = 1
NCSTATES                = 5
BUILDARGS               = MATLAB_ROOT=%MATLAB_ROOT% ALT_MATLAB_ROOT=%ALT_MATLAB_ROOT% MATLAB_BIN=%MATLAB_BIN% ALT_MATLAB_BIN=%ALT_MATLAB_BIN%  GENERATE_ERT_S_FUNCTION=0 GENERATE_ASAP2=0 EXTMODE_STATIC_ALLOC=0 EXTMODE_STATIC_ALLOC_SIZE=1000000 EXTMODE_TRANSPORT=0 TMW_EXTMODE_TESTING=0 OPTS="-DMATLAB_MEX_FILE -DTID01EQ=0"
MULTITASKING            = 0
INTEGER_CODE            = 0
MAT_FILE                = 0
ALLOCATIONFCN           = 0
...
MODELLIB                  = bh_DDR_component_modellib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = bh_DDR_component_model_ref.rsp
COMPILER_COMMAND_FILE     = bh_DDR_component_model_comp.rsp
